        ...
        <div className="p-3 project-card grid" >
            ...
            <div className="card-container">
                <div className="project-cards p-10   border border-secondary rounded g-col-12">
                    <img loading = "lazy"src="/typing_game.webp" className="project-image  rounded" alt="project image"></img>
                ...
                <div className="project-cards p-10   border border-secondary rounded g-col-12">
                    <img loading = "lazy"src="/EBG.webp" className="project-image  rounded" alt="project image"></img>
                    <div className="project-description">
            ...
            <div className="card-container">
                <div className="project-cards p-10   border border-secondary rounded g-col-12">
                    <img loading = "lazy"src="/AC_3000.webp" className="project-image  rounded" alt="project image"></img>
                    <div className="project-description">
            ...
            <div className="card-container">
                <div className="project-cards p-10   border border-secondary rounded g-col-12">
                    <img loading = "lazy"src="/score_board.webp" className="project-image  rounded" alt="project image"></img>
                    <div className="project-description">
                ...
                <div className="project-cards p-10   border border-secondary rounded g-col-12">
                    <img loading = "lazy"src="/pink_planner.webp" className="project-image  rounded" alt="project image"></img>
                    <div className="project-description">
